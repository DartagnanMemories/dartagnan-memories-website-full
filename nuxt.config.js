export default {
  ...
  head: {
    ...
    meta: [
      ...
      { name: 'image', content: 'https://dartagnanmemories.org/img/dmemories-twitter-preview.png' },
      ...
      { name: 'og:image', content: 'https://dartagnanmemories.org/img/dmemories-twitter-preview.png' },
